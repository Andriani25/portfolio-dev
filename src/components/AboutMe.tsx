...
export const AboutMe = () => {
  ...
  const translations = {
    ...
    description: language === "es"
      ? "Soy un desarrollador apasionado por crear soluciones tecnológicas innovadoras y eficientes. Con una sólida base en ingeniería de software y un enfoque constante en el aprendizaje de nuevas tecnologías, me especializo en construir aplicaciones web robustas y escalables que brindan una experiencia de usuario excepcional. Mi compromiso con la calidad del código y la resolución creativa de problemas me permite enfrentar desafíos complejos con confianza y profesionalismo, transformando ideas en realidades digitales impactantes."
      : "I am a developer passionate about creating innovative and efficient technological solutions. With a solid foundation in software engineering and a constant focus on learning new technologies, I specialize in building robust and scalable web applications that provide an exceptional user experience. My commitment to code quality and creative problem-solving allows me to face complex challenges with confidence and professionalism, transforming ideas into impactful digital realities."
  };
